                                                      ...
                                                      <form action="{{route('users.update',$user->id)}}" method="post" role="form text-left">
                                                        ...
                                                        @csrf
                                                          ...
                                                          <div class="input-group mb-3">
                                                            <input type="text" name="username" value="{{old('username',$user->username)}}" class="form-control"  placeholder="username" aria-label="permission name" aria-describedby="role name addon">
                                                          </div>
                                                          <label>First Name</label>
                                                          <div class="input-group mb-3">
                                                            <input type="text" name="firstname" value="{{old('firstname',$user->firstname)}}" class="form-control"  placeholder="first name" aria-label="permission name" aria-describedby="role name addon">
                                                          </div>
                                                          <label>Middle Name</label>
                                                          <div class="input-group mb-3">
                                                            <input type="text" name="middlename" value="{{old('middlename',$user->middlename)}}" class="form-control"  placeholder="middle name" aria-label="permission name" aria-describedby="role name addon">
                                                          </div>
                                                          <label>Last Name</label>
                                                          <div class="input-group mb-3">
                                                            <input type="text" name="lastname" value="{{old('lastname',$user->lastname)}}" class="form-control"  placeholder="last name" aria-label="permission name" aria-describedby="role name addon">
                                                          </div>
                                                          <div class="form-group">
