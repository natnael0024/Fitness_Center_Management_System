...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'User Management / Roles'])
                            ...
                            <tr>
                                ...
                                <td class="align-items-center justify-content-center  d-flex gap-4">
                                    <a  class="btn text-secondary font-weight-bold text-sm bg-secondary d-flex align-items-center  gap-2"
                                        data-bs-toggle="modal" data-bs-target="#editmodal{{$role->id}}" data-original-title="Edit">
                                    ...
                                    <a class="btn text-secondary font-weight-bold text-xs d-flex align-items-center bg-danger text-white"
                                        data-bs-toggle="modal" data-bs-target="#deletemodal{{$role->id}}" data-original-title="delete">
                                ...
                                {{-- edit --}}
                                    <div class="modal fade" id="editmodal{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                          <div class="modal-body p-0">
                                            <div class="card card-plain">
                                              <div class="card-header pb-0 text-left">
                                                <h3 class="font-weight-bolder text-dark">Edit Role : {{$role->name}}</h3>
                                              ...
                                              <div class="card-body">
                                                <form action="{{route('roles.update',$role->id)}}" method="POST">
                                                  ...
                                                  <div class="input-group mb-3">
                                                    <input type="text" name="name" class="form-control" value="{{old('name',$role->name)}}" placeholder="role name" aria-label="role name" aria-describedby="role name addon">
                                                  </div>
                                                  <div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        @foreach($permissions as $permission)
                                                            <div class="form-check d-flex col-md-4">
                                                                ...
                                                                <label class="form-check" for="perm-{{ $role->id }}-{{ $permission->id }}">
                                    ...
                                    {{-- delete --}}
                                        <div class="modal fade " id="deletemodal{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-body p-0">
                              <div class="card card-plain">
                                <div class="card-header pb-0 text-left">
                                  <h3 class="font-weight-bolder text-dark">Add Role</h3>
                                </div>
                                <div class="card-body">
                                  <form action="{{route('roles.store')}}" method="post" role="form text-left">
                                    ...
                                    <label>Role Name</label>
                                    <div class="input-group mb-3">
                                      <input type="text" name="name" class="form-control"  placeholder="role name" aria-label="role name" aria-describedby="role name addon">
                                    </div>
                                    <div>
                                        <label>Permissions</label>
                                        <div class="mb-3 row">
